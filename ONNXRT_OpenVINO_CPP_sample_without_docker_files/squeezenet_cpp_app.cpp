...
int main(int argc, char* argv[])
{
    ...
    std::string modelFilepath{"/home/maajid/project_files/python_samples_for_devcloud/intel_onnxrt_cpu_fp32_ov_2021.2_binary_jan23/onnxruntime/build/Linux/Debug/squeezenet1.1-7.onnx"};
    //std::string imageFilepath{"/home/maajid/project_files/python_samples_for_devcloud/intel_onnxrt_cpu_fp32_ov_2021.2_binary_jan23/onnxruntime/build/Linux/Debug/bird.jpg"};
    std::string imageFilepath{"/home/maajid/project_files/python_samples_for_devcloud/intel_onnxrt_cpu_fp32_ov_2021.2_binary_jan23/onnxruntime/build/Linux/Debug/devcloud/mask_rcnn/cars.jpg"};
    std::string labelFilepath{"/home/maajid/project_files/python_samples_for_devcloud/intel_onnxrt_cpu_fp32_ov_2021.2_binary_jan23/onnxruntime/build/Linux/Debug/synset.txt"};
    ...
    if (useOPENVINO)
    {
        ...
        options.device_type = "CPU_FP32"; //options.device_type = "HETERO:MYRIAD,CPU";
